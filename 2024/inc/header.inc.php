	...
	*/
	...
	<div class='dimmer'></div>
		<div class='header-content'>
			<div class='ident'>
				<img src='<?php echo $baseurl; ?>img/logo_dbh.webp' id='logo-subpage' class='logo show-for-medium hidden dbh' alt="Disobey"> <!-- Only for subpage -->
			...
			<section class="grid-x grid-padding-x grid-margin-x datetime text-center">
				<div class='cell large-6 large-text-right'>
					<h3><i class="far fa-clock"></i>16th and 17th February, 2024</h3>
				</div>

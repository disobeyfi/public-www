...
class TimeTable{
	...
	function output( $main_day_1, $w1_day_1, $w2_day_1, $w3_day_1, $day_string, $range_start){
			...
			$output .= $this->getColumn( $w2_day_1, 	3, "Security Theater", 	"cs", 	"CS", $day_string );
			$output .= $this->getColumn( $w1_day_1, 	3, "Workshop", 		"ws", 	"WS", $day_string );
...
<div class='schedule-list-container schedule-details text-center' >
	<h4 class="text-center" id="top">Friday 16th</h4>
...
<!-- Program day 2 -->
<div class='schedule-list-container schedule-details text-center' >
	<h4 class="text-center">Saturday 17th</h4>
	<?php

<head>
		<?php
			...
			$baseurl = ( $_SERVER['SERVER_NAME'] == "ddr.fi" )? "/disobey_2024/" : "/2024/";
      ...
      href="favicon.ico">
		...
		<meta property="og:url"                content="https://disobey.fi/2024<?php echo $slug; ?>" />
		...
		<meta property="og:image"              content="https://disobey.fi/2024/img/disobey_facebook.jpg" />
		...
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/main.css?v=27">
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/lists.css?v=18">
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/navigation.css?v=17">
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/header.css?v=17">
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/tables.css?v=17">

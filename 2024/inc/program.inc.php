	<div class='full-row clearfix lazyload translucent fullwidth' >
		<section class="grid-container cell grid-y cell location" id='schedule' >
			...
			<section id='program-intro' >
					<p>Below you can find the stage program guide for Disobey 2024 full of amazing talks and presentations. In addition, the Community Village has its own set of awesome scheduled and unscheduled program, which you can find on <a id='community-village-link' href='<?php echo $baseurl; ?>communityvillage<?php echo $suffix;?>'>the Community Village page! <span class='arrow right inline-arrow'></span></a></p>
			</section>

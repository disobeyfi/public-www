				...
				<section class="grid-container cell grid-y cell location" id='workshops' >
					...
					<div class='cell text-left grid-container grid-x grid-padding-x grid-margin-x grid-padding-y grid-margin-y'>
							...
							<div class='cell large-6'>
								...
								<p>On Friday, the doors and the wristband exchange will open at 11:30. Program ends at 22:00, and doors close at 22:30.</p>

								<p>On Saturday, doors will open to the public at 10:00, and the program ends at 22:00. Doors close at 22:30.
								Please see upcoming program pages for information on the actual program. </p>

								<p>Please refer to the program pages for scheduling – there may be changes, and the pages will have the latest info.</p>

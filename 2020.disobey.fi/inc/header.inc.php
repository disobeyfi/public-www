<div class='full-row header-row clearfix  transparent-bg' >
	...
	<div class='header-content'>
		<div class='ident'>
			...
			<!-- Only on frontpage -->
			<?php if( !empty( $is_frontpage ) ){ ?>
				<div id="animation_container" style="background-color:rgba(153, 153, 153, 0.00);">
					<canvas id="canvas" style="background-color:rgba(153, 153, 153, 0.00);"></canvas>
					<div id="dom_overlay_container" style="pointer-events:none; overflow:hidden;">
					</div>
				</div>
			<?php } ?>

			<img src='img/logo_subpage.png' id='logo-subpage' class='logo show-for-medium hidden' alt="Disobey">
			...
			<img src='img/logo_mobile.png' id='logo-mobile' class='logo show-for-small-only' alt="Disobey">
		...
		<section class="grid-x grid-padding-x grid-margin-x datetime text-center show-for-medium">
			<div class='cell large-6 large-text-right'>
				<h3><i class="far fa-clock"></i> From 14th to 15th of February, 2020</h3>
			</div>

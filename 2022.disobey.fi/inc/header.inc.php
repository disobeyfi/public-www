<div class='full-row header-row clearfix  transparent-bg' >
	...
	<div class='header-content'>
		<div class='ident'>
			<img src='img/logo.png' id='logo-subpage' class='logo show-for-medium hidden' alt="Disobey">
			...
			<img src='img/logo_mobile_no_date.png' id='logo-mobile' class='logo show-for-small-only' alt="Disobey">
		...
		<section class="grid-x grid-padding-x grid-margin-x datetime text-center show-for-medium">
			<div class='cell large-6 large-text-right'>
				<h3><i class="far fa-clock"></i> From 18th and 19th February, 2022</h3>
			</div>

<head>
      ...
      href="favicon.ico">
		...
		<meta property="og:url"                content="https://disobey.fi/2023<?php echo $slug; ?>" />
		...
		<meta property="og:image"              content="https://disobey.fi/2023/img/disobey_facebook.jpg" />
		...
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/main.css?v=22">
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/lists.css?v=15">
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/navigation.css?v=16">
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/header.css?v=15">
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/tables.css?v=15">
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/profiles.css?v=16">
		<link rel="stylesheet" type="text/css" href="<?php echo $baseurl; ?>css/timetable.css?v=5">
		...
		<script defer src="<?php echo $baseurl; ?>js/main.js?v=10"></script>
		<script>
